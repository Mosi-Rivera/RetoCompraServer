...
module.exports.generateAccessToken = function (userEmail, userRole, emailVerified) {
    return jwt.sign({ email: userEmail, role: userRole, emailVerified }, process.env.ACCESS_TOKEN_SECRET, { expiresIn: module.exports.msLifetimeAccessToken })
}
